                ...
                <div class="p-4 sm:p-7">
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <a wire:navigate class="text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/registro">
                                Registrate Aquí
                            </a>
                        </p>
                    </div>
                    ...
                    <form>
                        <div class="grid gap-y-4">
                            ...
                            <div>
                                ...
                                <p class="hidden text-xs text-red-600 mt-2" id="email-error">Incluya una dirección de correo electrónico válida para que podamos ponernos en contacto con usted.</p>
                            </div>
                            <!-- End Form Group -->
                            ...
                            <div>
                                <div class="flex justify-between items-center">
                                    ...
                                    <a wire:navigate class="text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/recuperacion">¿Contraseña Olvidada?</a>
                                </div>
                                <div class="relative">
                                ...
                                <p class="hidden text-xs text-red-600 mt-2" id="password-error">8+ caracteres requeridos</p>
                            </div>
                            <!-- End Form Group -->
