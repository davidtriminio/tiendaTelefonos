            ...
            <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
                <div class="p-4 sm:p-7">
                    <div class="text-center">
                        <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">¿Ha olvidado su contraseña?</h1>
                            ...
                            <div class="grid gap-y-4">
                                ...
                                <div>
                                    ...
                                    <div class="mt-2 bg-teal-500 text-sm text-white rounded-lg p-4" role="alert">
                                        <span class="font-bold text-center">Revisa tu correo para restablecer tu contraseña</span>
                                    </div>
                                    @endif
