    ...
    <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <section class="flex items-center font-poppins dark:bg-gray-800 ">
            <div class="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto bg-white border rounded-md dark:border-gray-900 dark:bg-gray-900 md:py-10 md:px-10">
                <div>
                    <h1 class="px-4 text-center text-3xl font-semibold tracking-wide text-red-900 dark:text-gray-300 ">
                        ¡La orden no existe!
                    </h1>
                </div>
                <div class="flex justify-content-center">
                    <div class="justify-center flex-1">
                        <a href="/productos" class="bg-slate-600 text-white py-2 px-4 rounded-md hover:bg-slate-500 m-auto justify-self-center">Ver Productos</a>
                    </div>
                </div>
            </div>
        </section>
